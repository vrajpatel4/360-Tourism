              ...
              <div class="row gap-20 gap-lg-30 mb-20">
                <div class="col-6 o2">
                  <div class="form-group">
                    <label for="form_name"><?php echo trans('0350');?></label>
                    <div class="clear"></div>
                ...
                <div class="col-6 o1">
                  <div class="form-group">
                    <label for="form_email"><?php echo trans('094');?></label>
                    <div class="clear"></div>
                ...
                <div class="col-12">
                  <div class="form-group">
                    <label for="form_subject"><?php echo trans('0261');?></label>
                    <div class="clear"></div>
                    <input id="form_subject" type="text" name="contact_subject" class="form-control" placeholder="<?php echo trans('0261');?>" required="required" data-error="Subject is required.">
                    <div class="help-block with-errors text-danger"></div>
                  </div>
                </div>
                </div>
                ...
                <div class="col-12">
                  <div class="form-group">
                    <label for="form_message"><?php echo trans('0262');?></label>
                    <div class="clear"></div>
                    <textarea id="form_message" name="contact_message" placeholder="<?php echo trans('0262');?>" class="form-control"  rows="6" required="required" data-error="Please,leave us a message."></textarea>
                    <div class="help-block with-errors text-danger"></div>
                  </div>
                </div>
                </div>
