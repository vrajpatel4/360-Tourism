   ...
   <div class="clear"></div>
                  <div class="bg-white-shadow pt-25 pb-30 ph-30 mb-30">
                    ...
                    <div class="row fe">
                      ...
                      <a id="popoverData" class="go-right" href="javascript:void(0);" data-content="<?php echo trans('0514');?>" rel="popover" data-placement="top" data-original-title="<?php echo trans('0515');?>" data-trigger="hover"><strong><?php echo trans('0515');?></strong></a>
                      <div class="clear"></div>  
                      <div class="input-group">
                        
                          <input type="text" class="o2 form-control coupon form-bg-light" placeholder="<?php echo trans('0166');?>">
