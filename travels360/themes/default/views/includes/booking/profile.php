                ...
                <form id="guestform" class="booking_page">
                    <div class="row gap-20 mb-0">
                        <div class="col-12 col-sm-6 o2">
                            <div class="form-group">
                                ...
                                <input class="form-control form-bg-light" type="text" placeholder="<?php echo trans('0171');?>" name="firstname"  value="">
                            </div>
                        </div>
                        <div class="col-md-6 col-12 o1">
                            <label><?php echo trans('0172');?> <span class="font12 text-danger">*</span></label>
                            <input class="form-control form-bg-light" type="text" placeholder="<?php echo trans('0172');?>" name="lastname"  value="">
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-md-6 col-12 o2">
                            ...
                            <div class="clear"></div>
                            <input class="form-control form-bg-light" type="text" placeholder="<?php echo trans('094');?>" name="email"  value="">
                        </div>
                        <div class="col-md-6 col-12 o1">
                            <label><?php echo trans('0175');?> <span class="font12 text-danger">*</span></label>
                            <div class="clear"></div>
                            <input class="form-control form-bg-light" type="email" placeholder="<?php echo trans('0175');?> <?php echo trans('094');?>" name="confirmemail"  value="">
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-md-12 col-12">
                            ...
                            <div class="clear"></div>
                            <input class="form-control form-bg-light" type="text" placeholder="<?php echo trans('0414');?>" name="phone"  value="">
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-md-12 col-12">
                            <label><?php echo trans('098');?> <span class="font12 text-danger">*</span></label>
                            <div class="clear"></div>
                            <input class="form-control form-bg-light" type="text" placeholder="<?php echo trans('098');?>" name="address"  value="">
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-md-12 col-12">
