    ...
    <div class="form-search-main-01">
        <form autocomplete="off" name="flightmanualSearch" action="<?= $search->route; ?>" method="GET" role="search">
            <div class="form-inner">
                <div class="row mb-10 row-reverse align-items-center row-return">
                            ...
                            <div id="airDatepickerRange-flight" class="row gap-10 mb-15">
                                ...
                                <div class="hidediv col-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-left">
                                            <span class="icon-font text-muted"><i class="bx bx-calendar"></i></span>
                                            <input id="FlightsDateEnd" autocomplete="false" class="form-control form-readonly-control" placeholder="<?php echo trans('0472'); ?>" name="reture_date" value="<?php echo $search->reture_date; ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                                <?php } ?>
