                                        ...
                                        <div class="panel">
                                            ...
                                            <div class="panel-body">
                                                <div class="form-group">
                                                    <label for="passenger_name_0"><?php echo trans('0350');?></label>
                                                    <input type="text" id="passenger_name_0" name="passenger[name]" class="form-control form-bg-light" placeholder="<?php echo trans('0350');?>">
                                                </div>
                                                <div class="form-group">
                                                    <label for="passenger_age_0"><?php echo trans('0524');?></label>
                                                    <input type="text" id="passenger_age_0" name="passenger[age]" class="form-control form-bg-light" placeholder="<?php echo trans('0524');?>">
                                                </div>
                                                <div class="form-group">
                                                    <label for="passenger_passport_0"><?php echo trans('0523');?> </label>
                                                    <input type="text" id="passenger_passport_0" name="passenger[passportnumber]" class="form-control form-bg-light" placeholder="<?php echo trans('0523');?>">
                                                </div>
                                            </div>
                                        </div>
