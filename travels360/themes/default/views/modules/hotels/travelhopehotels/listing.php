                ...
                <div class="wrapper-inner">
                  ...
                  <form name="fFilters" action="#" method="POST" role="search">
                    ...
                    <div class="sidebar-box">
                      ...
                      <div class="box-content">
                        <input id="price_range" value="<?=$selectedprice?>" data-slider-min="<?=$minprice?>"
                    ...
                    <div class="sidebar-box">
                      ...
                      <div class="box-content">
                        <div class="custom-control custom-radio">
                          <div><input type="radio" id="priceOrderDes" class="custom-control-input" name="priceOrder" value="des">&nbsp;&nbsp;<label class="custom-control-label" for="priceOrderDes"><?=trans('0599')?></label></div>
                          <div ><input type="radio" class="custom-control-input" id="priceOrderAsc" name="priceOrder" value="acs">&nbsp;&nbsp;<label class="custom-control-label" for="priceOrderAsc"><?=trans('0600')?></label></div>
                        </div>
                      </div>
                    </div>
                    <div class="sidebar-box">
          ...
          <div class="content-wrapper">
            ...
            <div id="listing">
              ...
              <?php foreach($hotels as $hotel):
               ...
               <li>
               <div class="product-long-item" data-price="<?=$hotel->price?>" data-stars="<?=$hotel->rating?>">
