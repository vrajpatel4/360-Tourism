...
<div class="row gap-20 mb-0">
    <div class="col-12 col-sm-6">
        <div class="form-group">
            <label><?php echo trans('0171');?> <span class="font12 text-danger">*</span></label>
            <input class="form-control form-bg-light" type="text" placeholder="<?php echo trans('0171');?>" name="first_name" required="" autocomplete="off">
        </div>
    </div>
    <div class="col-md-6 col-12">
        <label><?php echo trans('0172');?> <span class="font12 text-danger">*</span></label>
        <input class="form-control form-bg-light" type="text" required="" autocomplete="off" placeholder="<?php echo trans('0172');?>" name="last_name"  value="">
    </div>
</div>
<div class="row form-group">
    <div class="col-md-6 col-12">
        <label><?php echo trans('094');?> <span class="font12 text-danger">*</span></label>
        <input class="form-control form-bg-light" type="text" required="" autocomplete="off" placeholder="<?php echo trans('094');?>" name="email"  value="">
    </div>
   
    <div class="col-md-6 col-12">
        <label><?php echo trans('0175');?> <span class="font12 text-danger">*</span></label>
        <input class="form-control form-bg-light" type="email" required="" autocomplete="off" placeholder="<?php echo trans('0175');?> <?php echo trans('094');?>" name="confirmemail"  value="">
...
<div class="row form-group">
    <div class="col-md-6 col-12">
        <label><?php echo trans('0130');?><span class="font12 text-danger">*</span></label>
        <input class="form-control form-bg-light" required="" autocomplete="off" type="text" placeholder="<?php echo trans('0414');?>" name="phone">
    </div>
 <div class="col-md-6 col-12">
        <label><?=lang('08')?><span class="font12 text-danger">*</span></label>
        <input class="visadate form-control form-bg-light date" type="search" placeholder="<?=lang('08')?>" name="date" value="<?php echo $date?>" required="" autocomplete="off">
    </div>
</div>
<div class="form-group">
    <div class="panel panel-default guest" style="margin-bottom:-15px">
        ...
        <div id="special" aria-expanded="false" class="collapse">
            <div class="panel-body">
                <textarea class="form-control" placeholder="<?php echo trans('0415');?>" rows="4" name="notes"></textarea>
            </div>
        </div>
    </div>
</div>
