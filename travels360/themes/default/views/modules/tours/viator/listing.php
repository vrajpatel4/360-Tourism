                                ...
                                <div class="d-lg-flex mb-30">
                                    <div>
                                        <?php if (!empty(explode("/",uri_string())[3])) { ?>
                                            <h3 class="heading-title"><span><?=lang('Tours')?> <span class="text-lowercase"></span> </span> <span class="text-primary"><?= explode("/",uri_string())[3]; ?></span></h3>
                                        <?php } ?>
                                                    ...
                                                    <div class="row equal-height shrink-auto-md gap-15">
                                                        ...
                                                        <div class="col-12 col-auto">
                                                            <div class="col-inner d-flex flex-column">
                                                                ...
                                                                <div class="content">
                                                                    <?php echo character_limiter($item->data->shortDescription,150);?>
                                                                </div>
                                                                <div class="content-bottom mt-auto">
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div class="ml-auto">
                                                                            ...
                                                                            <a href="<?php echo base_url()?>viator/searchDetail/<?php echo $item->data->code?>" type="submit" class="btn btn-primary btn-sm btn-wide"><?php echo trans('0177');?></a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
