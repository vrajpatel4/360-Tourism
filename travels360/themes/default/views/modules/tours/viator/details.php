            ...
            <div class="container">
                <div class="d-flex flex-column flex-lg-row sb">
                    <?php if($appModule != "offers"){ ?>
                        <div class="o2">
                            <h2 id="detail-content-sticky-nav-00" class="name"><?php echo character_limiter($detail->title, 28);?></h2>
                                            ...
                                            <div class="the-hotel-item">
                                                <div class="form-group form-spin-group">
                                                    ...
                                                    <div class="form-icon-left">
                                                        ...
                                                        <input type="text" id="startDate" class="DateTours form-control form-readonly-control" placeholder="dd/mm/yyyy" value="<?=$toursearch['ToursSearchForm']->checkin?>" name="startDate" required>
                                                    </div>
                                                </div>
                                                <div class="form-group form-spin-group">
                                                    <label for="room-amount"><?php echo trans('08');?></label>
                                                    ...
                                                    <div class="form-icon-left">
                                                        <span class="icon-font text-muted"><i class="bx bx-calendar"></i></span>
                                                        <input type="text" id="endDate" class="DateTours form-control form-readonly-control" placeholder="dd/mm/yyyy" value="<?=$toursearch['ToursSearchForm']->checkin?>" name="endDate" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="content-wrapper">
                        <div class="slick-gallery-slideshow detail-gallery">
                            <div class="slider gallery-slideshow">
                                <?php foreach($detail->userPhotos as $img){ ?>
                                    <div>
                                        <div class="image"><img src="<?php echo $img->thumbnailURL; ?>" alt="<?php echo $img->caption; ?>" /></div>
                                    </div>
                                <?php } ?>
                            </div>
                                    ...
                                    <div class="feature-row">
                                        <div class="row gap-10 gap-md-30">
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <p class="go-text-left"><i class="fa fa-sun-o text-success"></i> <strong> <?php echo trans('0560');?> </strong> :   <?php echo $detail->duration;?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
    $("form").submit(function ( event ) {
        ...
        let arr = ['startDate',startDate,'endDate',endDate,'adults',Adult,'seniors',Senior,'youth',Youth,'child',Child,'infant',Infant,
            ...
            'title', title,'location',location,'duration',duration,'code',code];

        window.location.href = base_url + 'viator/checkAvailability/' + arr.join("/");
    });
</script>
<!-- aside -->
<script>
