                                    ...
                                    <form action="" method="GET" id="hello">
                                        <div class="hotel-room-sm-item">
                                            <div class="the-hotel-item">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <input name="date" type="text" class="form-control tourdate form-control-sm" placeholder="<?php echo trans('012');?>" value="<?php echo $module->date; ?>" >
                                                    </div>
                                                    <div class="col-12">
                    ...
                    <p>
                      <?php echo $specialCheckInInstructions; ?>
                        ...
                        <?php } ?>
                            ...
                            <h3 class="heading-title"><span><?=lang('0271')?> <?=lang('Viator')?></span></h3>
