              ...
              <div class="">
                ...
                <div class="form-group">
                  <span id="waiting"></span>
                    <?php if(!empty($module->duration)) {?>
                        <button type="submit" class="btn btn-success btn-lg btn-block completebook" name="<?php if(empty($usersession)){ echo "guest";}else{ echo "logged"; } ?>"  onclick="return completebook('<?php echo base_url();?>','<?php echo trans('0159')?>');"><?php echo trans('027');?></button>
                        <script>
                            function checkAvailability(){
                                $("#bookingdetails").submit(function (event) {
                                    ...
                                    let arr=['productCode',code,'startDate',startDate,'endDate',endDate];

                                    window.location.href = base_url + 'viator/beforeBooking/' + arr.join('/');
                                });
                            }
                        </script>
                    <?php } else{ ?>
