...
defined('SHOW_DEBUG_BACKTRACE') OR define('SHOW_DEBUG_BACKTRACE', TRUE);
    ...
    function my_baseURL(){
        ...
        else $base_url = 'http://localhost/tour360';
        return $base_url;
    }
    ...
    define('UPDATES_ROOT_URL', "http://update.wejkfh.store/updates/"); //remote url for updates list
     define('UPDATES_LIST_URL', "http://update.wejkfh.store/functions"); //remote url for updates list
     define('UPDATES_DETAIL_URL', 'http://wejkfh.store/detail.php'); //remote url for updates Details

    define('MAX_IMAGE_UPLOAD', 2050); // Maximum size in KB
    define('THUMB_WIDTH', 720);
    define('THUMB_HEIGHT', 480);
    define('PT_RIGHTS', 'PHPTRAVELS');
    define('PT_VERSION', 'v7.2');
