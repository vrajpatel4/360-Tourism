...
class Viatorback extends MX_Controller {
    ...
    public function __construct()
    {
        ...
        $chk = $this->App->service('ModuleService')->isActive('Viator');
        ...
        $this->data['page_title'] = 'Viator Setting';
    }
    ...
    {
        $this->data['moduleSetting'] = $this->App->service("ModuleService")->get("Viator");
        $this->data['main_content'] = 'Viator/settings';
        $this->data['page_title'] = 'Viator Settings';
        $this->data['header_title'] = 'Viator Settings';
    ...
    public function update_settings()
    {
        ...
        $this->App->service("ModuleService")->update('Viator', 'settings', $payload);
        redirect(base_url('admin/viator/settings'));
    }
