...
class HotelsSearchModel
{
    ...
    public function genrateQueryString()
    {
        ...
        return  "destination=".$this->hotellocation."&checkIn=".$hotelcheckin->format('Y-m-d')."&checkOut=".$hotelcheckout->format('Y-m-d')."&children=".$this->hotelchildren."&adults=".$this->hoteladult;
