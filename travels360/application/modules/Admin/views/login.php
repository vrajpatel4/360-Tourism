...
body:after {
  ...
  <script type="text/javascript">
   ...
   <div style="z-index: 9999;margin-top:-200px;position: fixed; width: 500px; height: 200px; margin: 7% auto; /* Will not center vertically and won't work in IE6/7. */ left: 0; right: 0;">
    <img data-wow-duration="0.5s" data-wow-delay="0.5s" src="<?php echo base_url(); ?>assets/img/admin.png" class="wow fadeIn center-block" style="width:78px;height:60px;margin-bottom:25px" alt="" />
