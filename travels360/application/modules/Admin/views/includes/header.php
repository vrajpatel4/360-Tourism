...
<html>
    ...
    #sidebar{min-width:200px;max-width:200px;background-color:#090f37;box-shadow:0 0 10px 0 rgba(0,0,0,.2);transition:all .3s;position:fixed;height:100%;z-index:1100;overflow-y:scroll;height:100vh}
    ...
    #sidebar i{margin-top:2px;color:rgba(154,154,175,.7411764705882353);position:absolute;left:10px;font-size:18px}
    ...
    .navbar-brand { background: #e7f0fa; color: rgba(0, 13, 166, 0.87); height: 63px; min-width: 64px!important; padding: 22px; }
    .navbar-brand:hover { background: #000DA6; color: rgba(245, 246, 255, 0.87); }
